...
ARG HAPI_FHIR_STARTER_URL=https://github.com/Boogy2/hapi-fhir-jpaserver-starter/
#ARG HAPI_FHIR_STARTER_URL=https://gitlab.gwdg.de/marius.koch/hapi-fhir-jpaserver-starter
...
FROM tomcat:9-jre11
#FROM eyaldahari/hardenedtomcat
